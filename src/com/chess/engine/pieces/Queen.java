...
public class Queen extends Piece{
	...
	private static final int[] CANDIDATE_MOVE_VECTOR_COORDINATES = {-7, -9, 7, 9, -1, -8, 1, 8};
	...
	private static boolean isFirstColumnExclusion(final int currentPosition, 
		...
		return BoardUtils.FIRST_COLUMN[currentPosition] && (candidateCoordinateOffset==-9 || candidateCoordinateOffset==7 || candidateCoordinateOffset==-1);
	}

	private static boolean isEightColumnExclusion(final int currentPosition, 
	final int candidateCoordinateOffset) {
		return BoardUtils.EIGHTH_COLUMN[currentPosition] && (candidateCoordinateOffset==9 || candidateCoordinateOffset==-7 || candidateCoordinateOffset==1);
	}
}
