...
public class Bishop extends Piece{
	...
	private static boolean isFirstColumnExclusion(final int currentPosition, 
		...
		return BoardUtils.FIRST_COLUMN[currentPosition] && (candidateCoordinateOffset==-9 || candidateCoordinateOffset==7);
	}
	
	private static boolean isEightColumnExclusion(final int currentPosition, 
			  final int candidateCoordinateOffset) {
		return BoardUtils.EIGHTH_COLUMN[currentPosition] && (candidateCoordinateOffset==9 || candidateCoordinateOffset==-7);
	}
}
